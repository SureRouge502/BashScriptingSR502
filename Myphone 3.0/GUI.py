...
def installapk():
 os.system("adb install "+chr(a.get()))
def githubpage():
...
button12_canvas = canvas1.create_window( 500, 400, anchor="nw", window = button12)
button13_canvas = canvas1.create_window( 650, 400, anchor="nw", window= button13)
button14_canvas = canvas1.create_window( 800, 400, anchor='nw', window= button14)
...
button18_canvas = canvas1.create_window( 950, 400, anchor="nw", window= button18)
